...
CDEC_RAW_DIR         = RAW_DIR / "cdec"
CDEC_FNF_KEY         = CDEC_RAW_DIR / "FNF_key.csv"
CDEC_DAILY_FNF_DIR   = CDEC_RAW_DIR / "daily_fnf"
CDEC_FNF_SHAPEFILE_DIR = ARCHIVE_DIR / "shapefiles"

# Individual GeoPackage exports from the GDB plus derived preparation layers.
GIS_DIR              = RAW_DIR / "gis"
...
# Combined USGS + CDEC training watershed boundaries (CSV + GeoJSON)
