...
def get_static_attrs(basin_id: str) -> ORJSONResponse:
    ...
    return ORJSONResponse(attrs)


@router.get("/{layer_key}/geojson")
def get_layer_geojson(layer_key: str) -> ORJSONResponse:
    ...
    return ORJSONResponse(layer.geojson)
